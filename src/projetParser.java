// $ANTLR 3.5.2 projet.g 2022-03-25 17:13:19
...
public class projetParser extends Parser {
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pf557); 
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,44,FOLLOW_44_in_parmod577); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:96:26: ';' pm
					{
					match(input,18,FOLLOW_18_in_parmod585); 
			...
			match(input,11,FOLLOW_11_in_parmod591); 
			}
	...
	public final void pm() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pm605);
			type();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pm612); 
		...
		try {
			...
			switch (alt28) {
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_inscond_in_instruction662);
					inscond();
					state._fsp--;
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_boucle_in_instruction668);
					boucle();
					state._fsp--;
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_lecture_in_instruction674);
					lecture();
					state._fsp--;
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_ecriture_in_instruction680);
					ecriture();
					state._fsp--;
				...
				case 6 :
					...
					{
					pushFollow(FOLLOW_affouappel_in_instruction686);
					affouappel();
					state._fsp--;
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			pushFollow(FOLLOW_expression_in_inssi705);
			expression();
			state._fsp--;
			...
			match(input,42,FOLLOW_42_in_inssi725); 
			PtGen.pt(200);
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_inscond765); 
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture854); 
			match(input,10,FOLLOW_10_in_lecture856); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_lecture864); 
					pushFollow(FOLLOW_ident_in_lecture866);
					ident();
					state._fsp--;
			...
			match(input,11,FOLLOW_11_in_lecture873); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture886); 
			match(input,10,FOLLOW_10_in_ecriture888); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture896); 
					pushFollow(FOLLOW_expression_in_ecriture898);
					expression();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11077); 
					pushFollow(FOLLOW_exp2_in_exp11080);
					exp2();
					state._fsp--;
	...
	public final void exp4() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp5_in_exp41223);
			exp5();
			state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp51299); 
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51320); 
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1349);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1357);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1365); 
					pushFollow(FOLLOW_expression_in_primaire1367);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1369); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1391); 
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1401); 
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,55,FOLLOW_55_in_valeur1411); 
					PtGen.pt(8); 
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1419); 
					PtGen.pt(9); 
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1449); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1460); 
	...
	public static final BitSet FOLLOW_14_in_pf557 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf559 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_44_in_parmod577 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_parmod579 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod581 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_18_in_parmod585 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod587 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_11_in_parmod591 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm605 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm607 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_14_in_pm612 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_inscond_in_instruction662 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_boucle_in_instruction668 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lecture_in_instruction674 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ecriture_in_instruction680 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_affouappel_in_instruction686 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_51_in_inssi703 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inssi705 = new BitSet(new long[]{0x0000000002000000L});
	...
	public static final BitSet FOLLOW_instructions_in_inssi717 = new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_inssi725 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_14_in_inscond765 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_43_in_lecture854 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture856 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture858 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture864 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture866 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_lecture873 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture886 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture888 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture890 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_ecriture896 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture898 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_35_in_exp11077 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp11080 = new BitSet(new long[]{0x0000000800000002L});
	...
	public static final BitSet FOLLOW_exp5_in_exp41223 = new BitSet(new long[]{0x000000000000A002L});
	...
	public static final BitSet FOLLOW_primaire_in_exp51283 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_12_in_exp51299 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51303 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_32_in_exp51320 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51323 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1349 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1357 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1365 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1367 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1369 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1383 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1391 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1393 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1401 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1403 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1411 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1419 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1449 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1460 = new BitSet(new long[]{0x0000000000000002L});
}
